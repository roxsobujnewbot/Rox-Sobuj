...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "Sinha") || (event.body.toLowerCase() == "Mishty")) {
     return api.sendMessage("আমার বস রক্স সবুজের বউকে কেউ ডাক দিবি না🙊😒", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "Rox") || (event.body.toLowerCase() == "Rox sobuj") || (event.body.toLowerCase() == "@Sobuj") || (event.body.toLowerCase() == "সবুজ")) {
     return api.sendMessage("আমার বস রক্স সবুজ উনি এখন কাজে বিজি আছে কি বলবেন আমাকে বলতে পারেন..!😘",threadID);

       
   };

   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ 🆁🅾🆇 ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 🆂🅾🅱🆄🅹.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/profile.php?id=100076118065968\nতার সাতে যোগা যোগ করবেন WhatsApp :- +0175570***", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:🆁🅾🆇 🆂🅾🅱🆄🅹 ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস রক্স সবুজ আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is  🆁🅾🆇 ❤️ তাকে সবাই 🆁🅾🆇 🆂🅾🅱🆄🅹 নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami Rox") || (event.body.toLowerCase() == "cup sala ami Rox sobuj") || (event.body.toLowerCase() == "madari")) {
  ...
  if ((event.body.toLowerCase() == "@MD Shiam Tafeder ") || (event.body.toLowerCase() == "Arif")) {
     return api.sendMessage("🥰-আরিফ-🌺 আমার বস উল্লাস'র বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Ami rox") || (event.body.toLowerCase() == "kire")) {
