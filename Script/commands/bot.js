...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "tor boss koy") || (event.body.toLowerCase() == "boss koy tor")) {
     return api.sendMessage("আমার বস রক্স সবুজ লুঙ্গি খুলে শুয়ে আছে🥵", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "rox") || (event.body.toLowerCase() == "rox koy") || (event.body.toLowerCase() == "@rox sobuj") || (event.body.toLowerCase() == "সবুজ")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ Rox ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 Rox Sobuj.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/profile.php?id=100076118065\nতার সাতে যোগা যোগ করবেন WhatsApp :- +0175570***", threadID);
   };

   if ((event.body.toLowerCase() == "tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:ROX ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস রক্স সবুজ আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami rox") || (event.body.toLowerCase() == "cup sala ami sobuj") || (event.body.toLowerCase() == "madari")) {
  ...
  if ((event.body.toLowerCase() == "@arif ") || (event.body.toLowerCase() == "arif")) {
     return api.sendMessage("🥰-আরিফ-🌺 আমার বস রক্স সবুজ এর বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
