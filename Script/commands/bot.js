...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "ullash") || (event.body.toLowerCase() == "Rox") || (event.body.toLowerCase() == "@rox") || (event.body.toLowerCase() == "Rox sobuj")) {
  ...
  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Rox ❤️ তাকে সবাই 🆁🅾🆇 🆂🅾🅱🆄🅹 নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "Arif") || (event.body.toLowerCase() == "আরিফ")) {
     return api.sendMessage("🥰-আরিফ চৌধুরী-🌺 আমার বস রক্স সবুজ'র বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
