...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "Rox") || (event.body.toLowerCase() == "Rox vai") || (event.body.toLowerCase() == "Rox koy") || (event.body.toLowerCase() == "রক্স সবুজ")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ ROX ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 🆁🅾🆇 🆂🅾🅱🆄🅹.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/profile.php?id=100076118065968\nতার সাতে যোগা যোগ করবেন WhatsApp :- +0175570***", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke")) {
     return api.sendMessage("My Creator:ROX❤️ হাই আমি মেছেন্জার ROBOT  আামার বস  🆁🅾🆇 🆂🅾🅱🆄🅹 আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Rox ッ❤️ তাকে সবাই 🆁🅾🆇 🆂🅾🅱🆄🅹 নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "Jim") || (event.body.toLowerCase() == "Raisa")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস রক্স সবুজ এর কলিজার বোন😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Kaira") || (event.body.toLowerCase() == "Mariya")) {
     return api.sendMessage("খবরদার কেউ  নজর দিবানা এটা আমার বস রক্স সবুজ এর কলিজার ব্রেস্টু লাগে..!😠🥰⛏️", threadID);
   };
  
  if ((event.body.toLowerCase() == "Kaira") || (event.body.toLowerCase() == "Cikni")) {
     return api.sendMessage("খবরদার কেউ নজর দিবানা এটা আমার বস রক্স সবুজ এর লাগবেই..!😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "@Arif ") || (event.body.toLowerCase() == "Arif")) {
     return api.sendMessage("🥰--🌺 আমার বস রক্স সবুজের বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
